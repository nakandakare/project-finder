...
const ContactFrom = ({ currentUser, sendContactData }) => {
  ...
  const options = [
    { key: "c", text: "Contact", value: "Contact" },
    { key: "f", text: "Feedback", value: "Feedback" },
    { key: "b", text: "Reporting Bugs", value: "Reporting Bugs" },
  ];
  ...
  return (
    <div className="contactForm">
      ...
      <Form className="formInputs" onSubmit={handleSubmit}>
        ...
        />
        <Form.Field className="contactSubmit" color="blue" control={Button}>
          Submit
        </Form.Field>
      </Form>
    </div>
